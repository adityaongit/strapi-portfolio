...
export interface ApiCertificateCertificate extends Schema.CollectionType {
  ...
  attributes: {
    ...
    credentialID: Attribute.String & Attribute.Required;
    issuer: Attribute.String & Attribute.Required;
    issueDate: Attribute.Date;
    certificateLink: Attribute.Text & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiExperienceExperience extends Schema.CollectionType {
  ...
  attributes: {
    ...
    companyLink: Attribute.Text & Attribute.Required;
    companyLogo: Attribute.Media & Attribute.Required;
    description: Attribute.Blocks & Attribute.Required;
    skillTag: Attribute.Blocks & Attribute.Required;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    projectLiveUrl: Attribute.Text;
    githubUrl: Attribute.Text;
    projectDescription: Attribute.Blocks & Attribute.Required;
    projectThumbnail: Attribute.Media & Attribute.Required;
    skillTag: Attribute.Blocks & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiSkillSkill extends Schema.CollectionType {
  ...
  attributes: {
    skillLogo: Attribute.Media & Attribute.Required;
